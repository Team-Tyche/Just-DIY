namespace Just_DIY.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        {
            IdentityUser<int, CustomUserLogin, CustomUserRole, CustomUserClaim> user = await UserManager.FindByIdAsync(User.Identity.GetUserId<int>());
